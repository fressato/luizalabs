...
from workoutapi.atleta.schemas import AtletaIn, AtletaOut, AtletaUpdate, AtletaBasicOut
...
async def query(db_session: DatabaseDependency, nome: str = None, cpf: str = None) -> LimitOffsetPage[AtletaBasicOut]:
